...
const About = () => {
  return (
    <div id='about' className='bg-texto dark:bg-background-second py-4 '>
        <div className='max-w-[80%] min-h-screen flex flex-col mx-auto sm:flex-row justify-between items-center'>
            ...
            <div className='flex flex-col mx-auto items-center mt-8 justify-center pl-4 md:ml-8 md:w-1/2'>
              ...
              <p className='p-2 text-xl sm:text-2xl m-4'>{`I'm a self taught Front End Developer, i'm always looking to improve my coding skills, the UX experience is fundamental in my projects. Let's chat a see what can i do for you`}</p>
            </div>
        </div>        
    </div>
  )
